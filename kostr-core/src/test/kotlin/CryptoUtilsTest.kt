...
//    }
    ...
    fun testGetPublicKey() {
        val testPublicKey =
            CryptoUtils.getPublicKey(Hex.decode("6ba903b7888191180a0959a6d286b9d0719d33a47395c519ba107470412d2069"))
    ...
    fun testContentHash() {
        ...
        assert(CryptoUtils.contentHash(word).toHexString() == correctHash) {
            "Hashes do not match!"
        }
    }
}